...
ALTER TABLE MEMBER ADD CONSTRAINT CK_LOAI CHECK (LOAI LIKE 'TRUONG' OR LOAI LIKE 'COSO' OR LOAI LIKE 'GIAOVIEN' OR LOAI LIKE 'SINHVIEN')
GO
--DROP TABLE MEMBER
--/*--INSERT VALUES FOR MEMBER--*/
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('TH101',123,'CS1','TRUONG')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('TH123',123,'CS2','GIAOVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('TH234',123,'CS1','GIAOVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('TH657',123,'CS2','TRUONG')

insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('001',123,'CS1','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('002',123,'CS2','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('003',123,'CS1','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('004',123,'CS2','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('005',123,'CS1','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('006',123,'CS2','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('007',123,'CS1','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('008',123,'CS2','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('009',123,'CS1','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('010',123,'CS2','SINHVIEN')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('011',123,'CS1','SINHVIEN')


insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('admin',1234567,'CS1','COSO')
insert into MEMBER (USERNAME,PASS,MACS,LOAI) VALUES ('Admin2',12345678,'CS2','COSO')
...
/*--GIAOVIEN(MAGV,HO,TEN,HOCVI,MAKH)--*/
INSERT GIAOVIEN VALUES (N'TH101', N'KIEU DAC', N'THIEN', N'THAC SI', N'CNTT')
INSERT GIAOVIEN VALUES (N'TH123', N'PHAN VAN ', N'HAI', N'THAC SI', N'CNTT')
INSERT GIAOVIEN VALUES (N'TH234', N'DAO VAN ', N'TUYET', N'TIEN SI', N'CNTT')
INSERT GIAOVIEN VALUES (N'TH657', N'PHAN HONG', N'NGOC', N'TIEN SI', N'VT')
GO
...
ALTER TABLE MEMBER ADD CONSTRAINT FK_MEMBER_COSO FOREIGN KEY (MACS) REFERENCES COSO (MACS) ON UPDATE CASCADE 
GO

ALTER TABLE SINHVIEN ADD CONSTRAINT FK_SINHVIEN_MEMBER FOREIGN KEY (MASV) REFERENCES MEMBER (USERNAME) ON UPDATE CASCADE 
GO

ALTER TABLE GIAOVIEN ADD CONSTRAINT FK_GIAOVIEN_MEMBER FOREIGN KEY (MAGV) REFERENCES MEMBER (USERNAME) ON UPDATE CASCADE 
GO

--ALTER TABLE GIAOVIEN DROP CONSTRAINT FK_GIAOVIEN_MEMBER
--ALTER TABLE SINHVIEN DROP CONSTRAINT FK_SINHVIEN_MEMBER
